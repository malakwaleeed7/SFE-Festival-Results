...
const defaultData = {
    games: [
        ...
        { id: 'running', name: 'Running (Boys)', icon: '🏃', type: 'individual' },
        { id: 'running2', name: 'Running (Girls)', icon: '🏃‍♀️', type: 'individual' },
        ...
        { id: 'quiz', name: 'Knowledge League', icon: '🧠', type: 'individual' },
        { id: 'singing', name: 'Singing', icon: '🎤', type: 'individual' },
        { id: 'table_tennis', name: 'Table Tennis', icon: '🏓', type: 'individual' },
        { id: 'tug_of_war', name: 'Tug of War (Boys)', icon: '🪢', type: 'team' },
        { id: 'tug_of_war_girls', name: 'Tug of War (Girls)', icon: '🪢', type: 'team' },
